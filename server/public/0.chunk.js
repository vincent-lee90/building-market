...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__my_store_publish_publish_component__ = __webpack_require__("./src/app/mine/my-store/publish/publish.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__my_store_store_display_store_display_component__ = __webpack_require__("./src/app/mine/my-store/store-display/store-display.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__my_store_publish_publish_component__ = __webpack_require__("./src/app/mine/my-store/publish/publish.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__my_store_store_display_store_display_component__ = __webpack_require__("./src/app/mine/my-store/store-display/store-display.component.ts");
...
var mineRoutes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'publish', component: __WEBPACK_IMPORTED_MODULE_9__my_store_publish_publish_component__["a" /* PublishComponent */]
            },
            {
                path: 'store-display', component: __WEBPACK_IMPORTED_MODULE_10__my_store_store_display_store_display_component__["a" /* StoreDisplayComponent */]
            },
            {
...
//# sourceMappingURL=E:/myProjects/building-market/src/my-store.component.js.map

/***/ }),

/***/ "./src/app/mine/my-store/publish/publish.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/mine/my-store/publish/publish.component.less":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./src/app/mine/my-store/publish/publish.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
PublishComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["d" /* Component */])({
        selector: 'publish',
        template: __webpack_require__("./src/app/mine/my-store/publish/publish.component.html"),
        styles: [__webpack_require__("./src/app/mine/my-store/publish/publish.component.less")]
    })
], PublishComponent);

//# sourceMappingURL=E:/myProjects/building-market/src/publish.component.js.map
...
var StoreDisplayComponent = (function () {
    function StoreDisplayComponent(mineService) {
        this.mineService = mineService;
        this.productList = [];
    }
    StoreDisplayComponent.prototype.getProductsByStoreCode = function () {
        var _this = this;
        this.mineService.getProductsByStoreCode().subscribe(function (data) {
